// PeatBid 問い合わせフォーム受信エンドポイント (Cloudflare Pages Functions)
// 必要な環境変数: DISCORD_WEBHOOK_URL (CF Pages ダッシュボード > Settings > Environment variables)
...
export async function onRequestPost(context) {
  ...
  const content = [
    `📨 **PeatBid 問い合わせ** ${MENTION_MEDIAXAI} ${MENTION_TOMOMI}`,
    `**種別:** ${type}`,
